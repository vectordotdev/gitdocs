...
describe('integration: manifest', () => {
  ...
  it('generates correct manifest object', async () => {
    ...
    expect(res.breadcrumb).to.have.length(1)
    expect(res.breadcrumb[0].title).to.equal('Mock')
    expect(res.breadcrumb[0].url).to.equal('/')
    ...
    expect(res.items[0].breadcrumb).to.have.length(2)
    expect(res.items[0].breadcrumb[0].title).to.equal('Mock')
    expect(res.items[0].breadcrumb[0].url).to.equal('/')
    expect(res.items[0].breadcrumb[1].title).to.equal('The Foo')
    expect(res.items[0].breadcrumb[1].url).to.equal('/foo/')
    ...
    expect(res.items[4].breadcrumb).to.have.length(2)
    expect(res.items[4].breadcrumb[0].title).to.equal('Mock')
    expect(res.items[4].breadcrumb[0].url).to.equal('/')
    expect(res.items[4].breadcrumb[1].title).to.equal('GitDocs')
    expect(res.items[4].breadcrumb[1].url).to.equal('/gitdocs/')
